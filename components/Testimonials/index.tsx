      ...
      <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
        ...
        <div className="animate_top mx-auto mb-16 text-center">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="mx-auto text-lg text-waterloo dark:text-manatee md:w-3/5"
          >
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="absolute left-0 top-1/2 z-10 -translate-x-4 -translate-y-1/2 md:-translate-x-16">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="flex h-12 w-12 items-center justify-center rounded-full bg-white/80 shadow-lg ring-1 ring-black/5 backdrop-blur-sm transition-all hover:bg-white dark:bg-blacksection/80 dark:ring-white/10 dark:hover:bg-blacksection"
          ...
          <div className="relative min-h-[450px]">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-white/80 p-10 shadow-2xl ring-1 ring-black/5 backdrop-blur-xl dark:bg-blacksection/80 dark:ring-white/10 md:p-16">
                  {/* Gradient Background */}
                  ...
                  <motion.p
                    ...
                    className="relative mb-10 text-center text-lg leading-relaxed text-black dark:text-white md:text-xl"
                  >
                  ...
                  >
                    {/* Avatar with Image */}
                    <div className={`relative mb-4 h-24 w-24 overflow-hidden rounded-full bg-gradient-to-br ${testimonials[currentTestimonial].gradient} p-1 shadow-xl ring-4 ring-white/50 dark:ring-black/50`}>
                      <div className="relative h-full w-full overflow-hidden rounded-full bg-white dark:bg-blacksection">
                        <Image
                  ...
                  {/* Decorative Elements */}
                  <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-gradient-to-br from-primary/10 to-transparent blur-3xl" />
                  <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-gradient-to-tl from-pink-100/20 to-transparent blur-3xl" />
                </div>
              </motion.div>
            </AnimatePresence>
          </div>
              ...
              <motion.button
                ...
                className={`h-3 rounded-full transition-all ${
                  index === currentTestimonial
                    ...
                    : "w-3 bg-stroke hover:bg-primary/50 dark:bg-strokedark"
                }`}
